  ...
  spreadEdges: [
    {
      ...
      sources: [
        demoSource('HBM4 단독 공급 계약 체결', '한국경제 · 06.02'),
        demoSource('HBM 시장 점유율 전망 상향', '매일경제 · 06.04'),
      ],
    },
    {
      from: 'origin',
      ...
      sources: [demoSource('청주 M15X 증설 계획 조기 확정', '한국경제 · 06.03')],
    },
    {
      from: 'origin',
      to: 'dc',
      reason: 'AI 가속기 출하 확대 → 데이터센터 증설 가속',
      sources: [demoSource('AI 데이터센터 투자 동향 점검', '매일경제 · 06.05')],
    },
    {
      from: 'hbm',
      to: 'pkg',
      reason: 'HBM 적층 물량 증가 → TC본더 등 후공정 수요 확대',
      sources: [demoSource('후공정 장비 발주 전망 상향', '이데일리 · 06.07')],
    },
    {
      from: 'hbm',
      to: 'material',
      reason: '생산 물량 확대 → 공정 소재 사용량 동반 증가',
      sources: [demoSource('반도체 소재 수급 타이트해져', '서울경제 · 06.08')],
    },
    {
      from: 'equip',
      to: 'test',
      reason: '장비 증설 → 수율 검증용 테스트·계측 수요 확대',
      sources: [demoSource('테스트 장비 시장 성장세 지속', '전자신문 · 06.09')],
    },
    {
      from: 'dc',
      to: 'server',
      reason: '데이터센터 증설 → AI 서버·고다층 기판 수요 증가',
      sources: [demoSource('AI 서버 출하 전망 상향 조정', '디지털타임스 · 06.10')],
    },
    {
      from: 'dc',
      to: 'power',
      reason: '전력 소모 급증 → 전력기기 발주 확대',
      sources: [demoSource('데이터센터 전력 수요 급증', '연합인포맥스 · 06.11')],
    },
    {
      from: 'pkg',
      to: 'gas',
      reason: '후공정 가동률 상승 → 특수가스·케미컬 소비 증가',
      sources: [demoSource('특수가스 수요 확대 국면', '머니투데이 · 06.12')],
    },
    {
      from: 'server',
      to: 'cooling',
      reason: '고밀도 서버 발열 → 냉각·열관리 솔루션 수요',
      sources: [demoSource('액체 냉각 시장 전망 상향', '전자신문 · 06.13')],
    },
    {
      from: 'server',
      to: 'grid',
      reason: '전력 사용량 증가 → 전력망 증설·ESS 수요',
      sources: [demoSource('전력망 투자 확대 가속', '연합인포맥스 · 06.14')],
    },
    {
      from: 'power',
      to: 'wire',
